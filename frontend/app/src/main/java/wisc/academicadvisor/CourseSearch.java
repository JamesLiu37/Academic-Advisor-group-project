...
public class CourseSearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // handling the colors of check boxes and their states
        int states[][] = {{android.R.attr.state_checked}, {}};
        int colors[] = {getResources().getColor(R.color.lightBlue), getResources().getColor(R.color.lightGray)};

        // set checkbox states
        CheckBox cb1 = (CheckBox)findViewById(R.id.biological_sciences);
        CheckBox cb2 = (CheckBox)findViewById(R.id.humanities);
        CheckBox cb3 = (CheckBox)findViewById(R.id.literature);
        CheckBox cb4 = (CheckBox)findViewById(R.id.natural_science);
        CheckBox cb5 = (CheckBox)findViewById(R.id.physical_science);
        CheckBox cb6 = (CheckBox)findViewById(R.id.social_science);
        CheckBox cb7 = (CheckBox)findViewById(R.id.interdivisional);

        CompoundButtonCompat.setButtonTintList(cb1, new ColorStateList(states, colors));
        CompoundButtonCompat.setButtonTintList(cb2, new ColorStateList(states, colors));
        CompoundButtonCompat.setButtonTintList(cb3, new ColorStateList(states, colors));
        CompoundButtonCompat.setButtonTintList(cb4, new ColorStateList(states, colors));
        CompoundButtonCompat.setButtonTintList(cb5, new ColorStateList(states, colors));
        CompoundButtonCompat.setButtonTintList(cb6, new ColorStateList(states, colors));
        CompoundButtonCompat.setButtonTintList(cb7, new ColorStateList(states, colors));
    ...
    public void launchURL(View v) {
        url_S = "http://tyleroconnell.com:8081/courses";
